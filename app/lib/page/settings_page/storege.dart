...
import 'package:ai_assisted_reader/providers/storage_info.dart';

import 'package:ai_assisted_reader/utils/get_path/get_base_path.dart';
import 'package:ai_assisted_reader/utils/get_path/storage_migration.dart';
...
class _StorageSettingsState extends ConsumerState<StorageSettings>
  ...
  Future<void> _selectNewPath() async {
    ...
    try {
      final testFile =
          File('$result${Platform.pathSeparator}.aar_permission_test');
