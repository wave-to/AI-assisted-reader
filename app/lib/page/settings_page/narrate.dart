...
import 'package:ai_assisted_reader/providers/tts_providers.dart';
import 'package:ai_assisted_reader/service/tts/models/tts_voice.dart';
import 'package:ai_assisted_reader/service/tts/online_tts.dart';
import 'package:ai_assisted_reader/service/tts/system_tts.dart';
import 'package:ai_assisted_reader/service/tts/tts_factory.dart';
import 'package:ai_assisted_reader/service/tts/tts_handler.dart';
import 'package:ai_assisted_reader/service/tts/tts_service.dart' as tts_svc;
...
import 'package:ai_assisted_reader/widgets/settings/service_config_form.dart';
...
class _NarrateSettingsState extends ConsumerState<NarrateSettings>
  ...
  Future<void> _testSpeak(String text, String? voiceShortName,
    ...
    try {
      ...
      AarLog.severe('TTS Test Speak Error: $e');
      if (mounted) {
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: Padding(
                  ...
                  child: AarButton.icon(
                    type: AarButtonType.text,
