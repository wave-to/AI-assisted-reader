...
import 'package:ai_assisted_reader/page/settings_page/ai_provider_list_page.dart';
import 'package:ai_assisted_reader/providers/ai_cache_count.dart';
import 'package:ai_assisted_reader/providers/ai_providers.dart';
import 'package:ai_assisted_reader/providers/user_prompts.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: AarSegmentedButton<AiChatDisplayMode>(
                    segments: [
                      SegmentButtonItem(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: AarSegmentedButton<AiPanelPositionEnum>(
                    segments: [
                      SegmentButtonItem(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                ...
                AarToast.show(L10n.of(context).commonSaveSuccess);
              },
              child: Text(L10n.of(context).commonSave),
            ),
          ],
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              AarToast.show(L10n.of(context).commonAddSuccess);
            },
            child: Text(L10n.of(context).commonConfirm),
          ),
        ],
