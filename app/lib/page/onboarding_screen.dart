  ...
  Widget _buildAppearanceSettings() {
    ...
    Widget buildThemeColorSelector() {
      final List<Color> themeColors = [
        const Color(0xFF2563EB), // Swiss Blue (默认)
        const Color(0xFF3B6B8B), // 墨蓝 (Paper Ink)
        const Color(0xFF475569), // Slate Grey (知识库风)
        const Color(0xFF6366F1), // Indigo
        const Color(0xFF7C5CBF), // AI 淡紫
        const Color(0xFF3B8B6B), // 松绿
        const Color(0xFF0891B2), // Cyan
        const Color(0xFF92400E), // 暖棕
        const Color(0xFFC4904A), // 琥珀
        const Color(0xFFDC2626), // Red
        const Color(0xFF16A34A), // Green
        const Color(0xFF1A1A1A), // 纯黑 (E-Ink)
      ];
