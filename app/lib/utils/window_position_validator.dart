...
class WindowPositionValidator {
  ...
  static Future<bool> isPositionValid(
    ...
    try {
      ...
      AarLog.warning('Failed to validate window position: $e');
      return false;
    }
  }
  ...
  static Future<Offset> getCenteredPosition(Size windowSize) async {
    try {
      ...
      AarLog.warning('Failed to calculate centered position: $e');
...
Future<void> initializeDesktopWindow() async {
  ...
  WindowManager.instance.setTitle('AI Assisted Reader');
