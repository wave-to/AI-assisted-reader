...
import 'package:ai_assisted_reader/utils/log/string_to_level.dart';
...
class AarLog {
  static final log = Logger('AarReader');
  ...
  AarLog(this.level, this.time, this.message);
  ...
  static AarLog parse(String log) {
    try {
      ...
      return AarLog(level, time, message);
    } catch (e) {
      return AarLog(Level.SEVERE, DateTime.now(), 'Parse log error: $e');
    }
  }
