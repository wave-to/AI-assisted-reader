...
class AarHeadlessWebView {
  ...
  Future<void> run() async {
    ...
    if (Platform.isWindows && webViewEnvironment == null) {
      AarLog.severe(
          'AarHeadlessWebView: webViewEnvironment is null on Windows, falling back to Overlay');
      _runOverlay();
      return;
    }
  ...
  void _runOverlay() {
    ...
    if (context == null) {
      AarLog.severe("No context available for AarHeadlessWebView overlay");
      return;
    }
