...
import 'package:ai_assisted_reader/enums/ai_prompts.dart';
import 'package:ai_assisted_reader/enums/bgimg_alignment.dart';
import 'package:ai_assisted_reader/enums/bgimg_type.dart';
import 'package:ai_assisted_reader/enums/bookshelf_folder_style.dart';
import 'package:ai_assisted_reader/enums/convert_chinese_mode.dart';
import 'package:ai_assisted_reader/enums/excerpt_share_template.dart';
...
import 'package:ai_assisted_reader/enums/sync_protocol.dart';
import 'package:ai_assisted_reader/enums/translation_mode.dart';
import 'package:ai_assisted_reader/enums/writing_mode.dart';
import 'package:ai_assisted_reader/enums/text_alignment.dart';
import 'package:ai_assisted_reader/enums/ai_panel_position.dart';
import 'package:ai_assisted_reader/enums/ai_chat_display_mode.dart';
import 'package:ai_assisted_reader/enums/bgimg_fit.dart';
import 'package:ai_assisted_reader/enums/code_highlight_theme.dart';
import 'package:ai_assisted_reader/l10n/generated/L10n.dart';
import 'package:ai_assisted_reader/main.dart';
import 'package:ai_assisted_reader/models/bgimg.dart';
import 'package:ai_assisted_reader/models/book_style.dart';
import 'package:ai_assisted_reader/models/chapter_split_presets.dart';
import 'package:ai_assisted_reader/models/chapter_split_rule.dart';
import 'package:ai_assisted_reader/models/font_model.dart';
import 'package:ai_assisted_reader/models/book_notes_state.dart';
import 'package:ai_assisted_reader/models/read_theme.dart';
import 'package:ai_assisted_reader/models/reading_info.dart';
...
class Prefs extends ChangeNotifier {
  ...
  Color get themeColor {
    int colorValue = prefs.getInt('themeColor') ?? 0xFF2563EB; // Swiss Minimal accent
  ...
  List<ChapterSplitRule> get chapterSplitCustomRules {
    ...
    try {
      ...
      AarLog.warning('Prefs: Failed to decode custom chapter split rules. $e');
  ...
  List<UserPrompt> get userPrompts {
    ...
    try {
      ...
      AarLog.severe('Error loading user prompts: $e');
      return [];
    }
  }
