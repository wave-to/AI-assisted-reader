...
import 'package:ai_assisted_reader/dao/tag.dart';
import 'package:ai_assisted_reader/service/ai/tools/repository/tag_repository.dart';
...
import 'package:ai_assisted_reader/utils/color/rgb.dart';
...
class _ApplyBookTagsStepTileState extends State<ApplyBookTagsStepTile> {
  ...
  Future<void> _applyPlan() async {
    ...
    try {
      ...
      AarToast.show('Tags updated');
    } catch (e) {
      if (!mounted) return;
      setState(() {
        _isApplying = false;
      });
      AarToast.show('Failed to apply tag changes: $e');
    }
  }
}
