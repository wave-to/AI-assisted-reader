...
import 'package:ai_assisted_reader/service/ai/tools/models/bookshelf_organize_plan.dart';
import 'package:ai_assisted_reader/service/ai/tools/models/bookshelf_organize_plan_group.dart';
import 'package:ai_assisted_reader/service/bookshelf/bookshelf_organize_service.dart';
...
import 'package:ai_assisted_reader/widgets/ai/tool_tiles/tool_tile_base.dart';
...
class _OrganizeBookshelfStepTileState
            ...
            TextButton.icon(
              onPressed: widget.step.output == null
                  ...
                  : () {
                      ...
                      AarToast.show(L10n.of(context).planCopied);
                    },
  ...
  Future<void> _applyPlan() async {
    ...
    try {
      ...
      AarToast.show(L10n.of(context).bookshelfUpdated);
    } catch (error) {
      if (!mounted) return;
      setState(() {
        _isApplying = false;
      });
      AarToast.show(L10n.of(context).failedToApplyPlan(error));
    }
  }
