...
import 'package:ai_assisted_reader/providers/ai_chat.dart';
import 'package:ai_assisted_reader/providers/ai_history.dart';
import 'package:ai_assisted_reader/providers/ai_providers.dart';
import 'package:ai_assisted_reader/service/ai/ai_services.dart';
import 'package:ai_assisted_reader/service/ai/ai_history.dart';
...
import 'package:ai_assisted_reader/utils/ai_reasoning_parser.dart';
import 'package:ai_assisted_reader/widgets/ai/model_picker_dialog.dart';
import 'package:ai_assisted_reader/widgets/ai/tool_step_tile.dart';
import 'package:ai_assisted_reader/widgets/ai/tool_tiles/apply_book_tags_step_tile.dart';
import 'package:ai_assisted_reader/widgets/ai/tool_tiles/mindmap_step_tile.dart';
import 'package:ai_assisted_reader/widgets/ai/tool_tiles/organize_bookshelf_step_tile.dart';
...
import 'package:ai_assisted_reader/widgets/delete_confirm.dart';
...
import 'package:ai_assisted_reader/models/ai_quick_prompt_chip.dart';
...
class AiChatStreamState extends ConsumerState<AiChatStream> {
            ...
            Padding(
              ...
              child: ActionChip(
                avatar: Icon(chip.icon, size: 16,
                    color: AiColors.aiPurple.withAlpha(180)),
                label: Text(chip.label, style: TextStyle(fontSize: 12)),
                backgroundColor: AiColors.aiPurple.withAlpha(10),
                side: BorderSide(
                    color: AiColors.aiPurple.withAlpha(40)),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: _suggestedPrompts
                        .map(
                          (prompt) => ActionChip(
                            label: Text(prompt, style: TextStyle(fontSize: 13)),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  topLeft: isUser ? const Radius.circular(14) : Radius.zero,
                  topRight: isUser ? Radius.zero : const Radius.circular(14),
                  bottomLeft: isUser ? Radius.zero : const Radius.circular(14),
                  bottomRight: isUser ? const Radius.circular(14) : Radius.zero,
                ),
                border: isUser ? null : Border.all(
                  color: AiColors.aiPurple.withAlpha(30),
                  width: 0.5,
                ),
              ),
              child: Column(
  ...
  Widget _buildThinkingPanel(List<Widget> children) {
    final theme = Theme.of(context);
    final accentColor = AiColors.aiPurple.withValues(alpha: 0.85);
    final subtleColor = AiColors.aiPurple.withValues(alpha: 0.65);
    return Theme(
