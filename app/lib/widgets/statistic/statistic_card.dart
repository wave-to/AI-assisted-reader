...
import 'package:ai_assisted_reader/widgets/statistic/heatmap_chart.dart';
import 'package:ai_assisted_reader/widgets/statistic/statistic_chart.dart';
...
class StatisticCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget segmentButton(data) => Row(
          children: [
            Expanded(
              child: AarSegmentedButton<ChartMode>(
