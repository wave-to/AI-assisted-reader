...
import 'package:ai_assisted_reader/enums/book_sync_status.dart';
...
import 'package:ai_assisted_reader/widgets/bookshelf/book_sync_status_icon.dart';
import 'package:ai_assisted_reader/widgets/linear_proportion_bar.dart';
            ...
            OutlinedButton.icon(
              ...
              onPressed: () {
                ...
                if (remoteOnlyIds.isNotEmpty) {
                  ...
                  AarToast.show(l10n.allBooksAreDownloaded);
                }
              },
            ),
            ...
            Expanded(
              child: FilledButton.icon(
                ...
                onPressed: () {
                  ...
                  if (isSyncing) {
                    AarToast.show(l10n.webdavSyncing);
                  } else {
