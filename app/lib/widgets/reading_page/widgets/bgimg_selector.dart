...
import 'package:ai_assisted_reader/enums/bgimg_theme_mode.dart';
...
import 'package:ai_assisted_reader/providers/bgimg.dart';
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: AarSegmentedButton<BgimgFitEnum>(
              segments: items,
