...
import 'package:ai_assisted_reader/widgets/reading_page/more_settings/page_turning/page_turn_dropdown.dart';
  ...
  Widget build(BuildContext context) {
        ...
        return ListTile(
          ...
          title: Row(
            ...
            children: [
              ...
              const Spacer(),
              AarSegmentedButton<PageTurnMode>(
                segments: [
                  SegmentButtonItem(
    ...
    return Container(
      ...
      child: Column(
        children: [
          fullScreen(),
          if (AarPlatform.isAndroid) keyboardTurnPage(),
          // if (PageTurnMode.fromCode(Prefs().pageTurnMode) ==
          //     PageTurnMode.simple)
          swapPageTurnArea(),
          showMenuOnHover(),
          if (AarPlatform.isDesktop) keyboardShortcutTurnPage(),
