          ...
          return Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: AarSegmentedButton<ConvertChineseMode>(
                      segments: [
                        SegmentButtonItem(
        ...
        builder: (context, setState) => Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: AarSegmentedButton<WritingModeEnum>(
                    segments: [
                      SegmentButtonItem(
        ...
        builder: (context, setState) => Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: AarSegmentedButton<TranslationModeEnum>(
                    enabled: isReading,
                    segments: [
                      SegmentButtonItem(
                        label: L10n.of(context).readingPageOriginal,
          ...
          return Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: AarSegmentedButton<String>(
                      segments: [
                        SegmentButtonItem(
