...
enum AarButtonType { filled, outlined, text }

class AarButton extends StatelessWidget {
  const AarButton({
    super.key,
    ...
    this.type = AarButtonType.filled,
    this.style,
    this.onLongPress,
    this.onHover,
    this.onFocusChange,
    ...
    if (isLoading) {
      buttonContent = SizedBox(
        ...
        child: CircularProgressIndicator(
          strokeWidth: 2.0,
          color: type == AarButtonType.filled
