...
import 'package:ai_assisted_reader/providers/font_list.dart';
...
import 'package:ai_assisted_reader/utils/save_img.dart';
import 'package:ai_assisted_reader/utils/share_file.dart';
import 'package:ai_assisted_reader/utils/toast/common.dart';
import 'package:ai_assisted_reader/widgets/book_share/excerpt_share_card.dart';
import 'package:ai_assisted_reader/widgets/icon_and_text.dart';
import 'package:ai_assisted_reader/widgets/show_loading.dart';
...
class _ExcerptShareBottomSheetState
  ...
  Future<Uint8List?> _captureCard() async {
    try {
      ...
      AarToast.show('Capture card error');
      AarLog.severe('Capture card error: $e');
      return null;
    }
  }
  ...
  Future<void> _shareAsImage() async {
    ...
    final file = File('$tempDir/aar_excerpt_share.png');
  ...
  Future<void> _saveAsImage() async {
    ...
    final fileName = 'AarReader_${widget.bookTitle.replaceAll(' ', '_')}';
